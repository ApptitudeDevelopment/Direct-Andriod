...
public class ProfileActivity extends AppCompatActivity {
    ...
    private DatabaseReference friendRequestReference, contactsRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background_profile_view = findViewById(R.id.background_image_view);
    ...
    private void manageClickEvents() {
        ...
        if (senderUserId.equals(receiverUserID)) {  // check cant add user themselves
